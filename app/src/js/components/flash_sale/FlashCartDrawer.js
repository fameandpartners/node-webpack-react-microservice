...
// UI Components
import CartEmpty from '../../../js/components/shared/cart/CartEmpty';
...
class FlashCartDrawer extends Component {
  constructor(props) {
    super(props);
    autoBind(this);
  }
...
FlashCartDrawer.defaultProps = {
  cartDrawerOpen: false,
};

export default connect(stateToProps, dispatchToProps)(FlashCartDrawer);
